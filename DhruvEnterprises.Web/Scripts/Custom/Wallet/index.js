...
(function ($) {
    ...
    function walletindex() {
                ...
                if (value == '' || value == null) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            debugger;
                            $('#CurrentBalance').html('Wallet-Bal: ' + data.bal.toFixed(2));
                            $('#CreditBalance').html('Credit-Bal: ' + data.cbal.toFixed(2));
                        }
                    });
                }
            });
        ...
        $this.init = function () {
            ...
            formAddEditLocation = new Global.FormHelper($("#model-index-wallet"), { updateTargetId: "validation-summary", validateSettings: { ignore: '' } });
        };
    }
    $(function () {
        var self = new walletindex();
        self.init();
    });
