    ...
    function ReportIndex() {
        ...
        function initializeGrid() {
            ...
            var locationGrid = new Global.GridAjaxHelper('#grid-index', {
                "aoColumns": [
                    /*{ "sName": "Id" },*/
                    { "sName": "Id" },
                    { "sName": "User.UserProfile.FullName" },
                    { "sName": "TxnId" },
                    { "sName": "ApiSource.ApiName" },
                    { "sName": "AccountNo" },
                    { "sName": "Operator.Name" },
                    { "sName": "Amount" },
                    { "sName": "RCType.TypeName" },
                    { "sName": "StatusType.TypeName" },
                    { "sName": "RequestTime" },
                    { "sName": "ResponseTime" },
                    { "sName": "MediumType.TypeName" },
                    { "sName": "StatusMsg" },
                    { "sName": "UserTxnId" },
                    { "sName": "OurRefTxnId" },
                    { "sName": "ApiTxnId" },
                ...
                "order": [[1, "desc"]],
                "aoColumnDefs": [
                    Global.CurrentRoleId == 3 ? { 'visible': false, 'aTargets': [3, 11, 12, 14, 15, 16] } : { 'bSortable': false, 'aTargets': [1] }
                ]

            }, "RechargeReport/GetDmtReport", filterdata);
        }
        ...
        function initializeModalWithForm() {
            ...
            $('#btnSearch').on('click', function () {
                ...
                var requrl = '/RechargeReport/DmtReport?i=' + Isa;
                var routeval = '';
            ...
            $('#btnExport').on('click', function () {
                ...
                var Edate = $('#txtToDate').val();
                var Sid = $('select#ddStatus :Selected').val();
                var Apiid = 110;// $('select#ddVendor :Selected').val();
                var Uid = $('select#ddUser :Selected').val();
                var Opid = $('select#ddOperator :Selected').val();
                var Customerno = $('#txtCustomerNo').val();
                var OpTxnid = $('#txtOpTxnid').val();
