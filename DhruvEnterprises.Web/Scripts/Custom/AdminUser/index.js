    ...
    function AdminUserIndex() {
        ...
        function initializeGrid() {
            ...
            var locationGrid = new Global.GridAjaxHelper('#grid-index', {
                "aoColumns": [
                     ...
                     { "sName": "BlockAmt" },
                    {
                        "sName": "IsActive", "mRender": function (data, type, row) {
                            if (type === 'display') {
                                if (data) {
                                    return '<input type="checkbox" checked="checked" class="switchBox switch-small simple" value="' + row[0] + '" ' + (row[10] ? "" : " disabled") + '/>';
                                }
                                else {
                                    return '<input type="checkbox" class="switchBox switch-small simple"  value="' + row[0] + '" ' + (row[10] ? "" : " disabled") + '/>';
                                }
                            }
                            return data;
                        }
                ...
                "order": [[0, "desc"]]
            }, "user/getadminusers", fdata, function () {
        ...
        function initializeModalWithForm() {
            ...
            $('#btnSearch').on('click', function () {
                ...
                var requrl = '/User/Index?a=' + fdata.Isa;
                var routeval = '';
